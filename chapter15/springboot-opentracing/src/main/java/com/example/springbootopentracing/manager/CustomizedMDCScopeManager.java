package com.example.springbootopentracing.manager;
...
public class CustomizedMDCScopeManager implements ScopeManager {
    ...
    public static class Builder {
        ...
        private String mdcTenantIdKey = "X-MS-TenantId";
        private String mdcActorIdKey = "X-MS-ActorId";
    ...
    private class MDCScope implements Scope {
        ...
        protected void putContext(JaegerSpanContext spanContext) {
            ...
            replace(mdcTenantIdKey, spanContext.getBaggageItem("X-MS-TenantId"));
            replace(mdcActorIdKey, spanContext.getBaggageItem("X-MS-ActorId"));
        }
